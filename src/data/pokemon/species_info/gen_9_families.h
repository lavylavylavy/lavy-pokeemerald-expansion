...
const struct SpeciesInfo gSpeciesInfoGen9[] =
{
    ...
    [SPECIES_WIGLETT] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_3),
        .abilities = { ABILITY_GOOEY, ABILITY_RATTLED, ABILITY_SAND_GUARD },
        .bodyColor = BODY_COLOR_WHITE,
    ...
    [SPECIES_ORTHWORM] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_EARTH_EATER, ABILITY_NONE, ABILITY_SAND_GUARD },
        .bodyColor = BODY_COLOR_PINK,
    ...
    [SPECIES_SLITHER_WING] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_FLARE_BOOST, ABILITY_MEGAFAUNA, ABILITY_COLD_BLOODED },
        .bodyColor = BODY_COLOR_WHITE,
        .speciesName = _("VESTAMOTH"),
    ...
    [SPECIES_IRON_MOTH] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_ELECTROSHIELD, ABILITY_MOTOR_DRIVE, ABILITY_SOLAR_POWER },
        .bodyColor = BODY_COLOR_WHITE,
        .speciesName = _("SYNTHORONA"),
        .cryId = CRY_IRON_MOTH,
        .natDexNum = NATIONAL_DEX_IRON_MOTH,
        .categoryName = _("SOLAR POWER"),
        .height = 12,
        .weight = 360,
        .description = COMPOUND_STRING(
