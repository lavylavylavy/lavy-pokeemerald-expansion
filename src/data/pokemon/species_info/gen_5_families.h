...
const struct SpeciesInfo gSpeciesInfoGen5[] =
{
    ...
    [SPECIES_SNIVY] =
    {
        ...
        .abilities = { ABILITY_OVERGROW, ABILITY_CONTRARY, ABILITY_CONDESCEND },
    ...
    [SPECIES_TEPIG] =
    {
        ...
        .abilities = { ABILITY_BLAZE, ABILITY_RECKLESS, ABILITY_JUGGERNAUT },
    ...
    [SPECIES_EMBOAR_MEGA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_HEAVYWEIGHT, ABILITY_HEAVYWEIGHT, ABILITY_HEAVYWEIGHT },
        .bodyColor = BODY_COLOR_RED,
        .noFlip = TRUE,
        .speciesName = _("EMBOAR"),
    ...
    [SPECIES_TYMPOLE] =
    {
        ...
        .abilities = { ABILITY_DAMP, ABILITY_SWIFT_SWIM, ABILITY_LIQUID_VOICE },
        .bodyColor = BODY_COLOR_BLUE,
...
#define COTTONEE_FAMILY_TYPE2 (P_UPDATED_TYPES >= GEN_6 ? TYPE_FAIRY : TYPE_GRASS)
    ...
    [SPECIES_PETILIL] =
    {
        ...
        .abilities = { ABILITY_CHLOROPHYLL, ABILITY_OWN_TEMPO, ABILITY_FLOWER_VEIL },
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_LILLIGANT] =
    {
        ...
        .weight = 163,
        .description = COMPOUND_STRING(
            "When it finds a male partner, its\n"
            "beautiful flower droops and withers.\n"
            "Its flower dies if it is not\n"
            "well-cared-for."),
        .pokemonScale = 320,
        .pokemonOffset = 7,
        .trainerScale = 256,
    ...
    [SPECIES_LILLIGANT_HISUI] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_GRASS),
        .abilities = { ABILITY_CHLOROPHYLL, ABILITY_HUSTLE, ABILITY_FLOWER_VEIL },
        .bodyColor = BODY_COLOR_GREEN,
        .noFlip = TRUE,
        .speciesName = _("LILLIGANT"),
        .cryId = CRY_LILLIGANT,
    ...
    [SPECIES_STUNFISK] =
    {
        ...
        .abilities = { ABILITY_STATIC, ABILITY_LIMBER, ABILITY_SAND_GUARD },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_KINGAMBIT] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_HUMAN_LIKE),
        .abilities = { ABILITY_DEFIANT, ABILITY_LAST_BASTION, ABILITY_PRESSURE },
        .bodyColor = BODY_COLOR_BLACK,
    ...
    [SPECIES_LARVESTA] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_FLAME_BODY, ABILITY_SWARM, ABILITY_PUGILIST },
        .bodyColor = BODY_COLOR_WHITE,
