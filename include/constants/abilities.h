...
enum __attribute__((packed)) Ability
{
    ...
    //new abilities
    ABILITY_HEAT_LIGHTNING = ABILITIES_COUNT_GEN9,
    ABILITY_PROVIDENCE = 320,
    ABILITY_SNOW_FORCE = 321,
    ABILITY_CONDESCEND = 322,
    ABILITY_HEAVYWEIGHT = 323,
    ABILITY_DESPERADO = 324,
    ABILITY_SPIRIT_BOND = 325,
    ABILITY_TRASH_TALK = 326,
    ABILITY_PUGILIST = 327,
    ABILITY_COLD_BLOODED = 328,
    ABILITY_ELECTROSHIELD = 329,
    ABILITY_INSULATION = 330,
    ABILITY_MEGAFAUNA = 331,
    ABILITY_CREPUSCULAR = 332,
    ABILITY_SPELLCASTER = 333,
    ABILITY_SAVANT = 334,
    ABILITY_MASTERMIND = 335,
    ABILITY_MISTY_CLOAK = 336,
    ABILITY_JUGGERNAUT = 337,
    ABILITY_HARBINGER = 338,
    ABILITY_DRACONIC = 339,
    ABILITY_SAND_SPIRIT = 340,
    ABILITY_TOXIC_TOUCH = 341,
    ABILITY_KICKBOXER = 342,
    ABILITY_SPACE_WARP = 343,
    ABILITY_TIME_WARP = 344,
    ABILITY_SHRED = 345,
    ABILITY_VAMPIRIC = 346,
    ABILITY_BLITZ_BOXER = 347,
    ABILITY_WIND_WAKER = 348,
    ABILITY_GEOLOGIC = 349,
    ABILITY_PERMAFROST = 350,
    ABILITY_INVINCIBLE = 351,
    ABILITY_ARCHITECT = 352,
    ABILITY_TRICKSTER = 353,
    ABILITY_SLUGGISH = 354,
    ABILITY_SINGULARITY = 355,
    ABILITY_FRIGID_BODY = 356,
    ABILITY_VANGUARD = 357,
    ABILITY_SHACKLE = 358,
    ABILITY_TRACTOR_BEAM = 359,
    ABILITY_DEPLETION = 360,
    ABILITY_DAO = 361,
    ABILITY_SWEET_DREAMS = 362,
    ABILITY_TRICKLE_DOWN = 363,
    ABILITY_DETONATE = 364,
    ABILITY_POINTY = 365,
    ABILITY_RESONANCE = 366,
    ABILITY_IMMOLATE = 367,
    ABILITY_FERTILIZE = 368,
    ABILITY_HEAVY_PINCER = 369,
    ABILITY_ONE_TWO = 370,
    ABILITIES_COUNT_NEW,
